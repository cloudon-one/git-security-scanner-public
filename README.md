...
[![Release](https://img.shields.io/github/v/release/cloudon-one/git-security-scanner-public)](https://github.com/cloudon-one/git-security-scanner-public/releases/tag/2.3)
